...
from postmanpat.views.modals.manager.invite_postie_confirmation import (
    get_invite_postie_confirmation_view,
)
...
async def invite_postie_callback(ack: AsyncAck, body, client: AsyncWebClient):
    view = body.get("view")
    selected_user = view["state"]["values"]["user-select"]["invite-postie"][
        "selected_user"
    ]
    ...
    view = get_invite_postie_confirmation_view(selected_user)
